...
<head runat="server">
    <title>AAIT Chat : Chat Page</title>
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.messageReceived = function (userName, message, time, userimg) {
                ...
                if (CurrUser1 != userName) {
                    ...
                    IntervalVal = setInterval("ShowTitleAlert('AAIT Chat App', '" + Notification + "')", 800);
        ...
        <div class="content-wrapper">
            ...
            <header class="main-header" style="background: #bedaeb">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>AAIT</b> Chat App</span>
                </a>
